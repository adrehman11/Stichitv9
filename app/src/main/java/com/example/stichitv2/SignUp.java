    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signup_buttton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // ADD USER TO COMETCHATRPRO

//                com.cometchat.pro.models.User user = new User();
//                user.setUid("tailor1"); // Replace with the UID for the user to be created
//                user.setName("keva  "); // Replace with the name of the user
//                user.setRole("tailorrole");
//
//                CometChat.createUser(user, CometChatConfig.authKey, new CometChat.CallbackListener<User>() {
//                    @Override
