...
public class TailorRejectedOrderDetails extends AppCompatActivity {
    private ImageView back_btn_orderDetail;
    private TextView dresstype,ordersid,ordertype,oderdeadline,phone_no,orderDate,orderstarted,dresstype_2,tailorname
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tailor_rejected_order_details);
        progressDialog = new ProgressDialog((TailorRejectedOrderDetails.this));
        progressDialog.show();
        ...
        back_btn_orderDetail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(v.getContext(), RejectedOrderTailor.class);
        ...
        phone_no = findViewById(R.id.textView22);
                ...
                public void onResponse(JSONObject response) {
                    ...
                    try {
                        ...
                        if (message.equals("details")){
                            ...
                            //orderstarted .setText(response.getString("orderDate"));
